...
\end{theorem}
\begin{proof}
We will prove that, energy-reachability game is equivalent to infinite-energy game by both side reduction. The theorem will be the consequence of the proof from ~\cite{BouyerFLMS08}.\\
...
\begin{figure}
    \label{inf-reach}
    \centering
    \input{chapters/chapter03/inf-reach.tex}
